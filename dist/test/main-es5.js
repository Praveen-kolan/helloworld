...
var AppComponent = /** @class */ (function () {
    ...
    Object.defineProperty(AppComponent.prototype, "result", {
        get: function () {
...
var TodoListComponent = /** @class */ (function () {
    ...
    TodoListComponent.prototype.tooggle = function (e) {
    ...
    TodoListComponent.prototype.getUsers = function () {
        return this.userService.getUsersFromData();
    };
    TodoListComponent.prototype.showEditUserForm = function (user) {
        if (!user) {
            this.userForm = false;
            return;
        }
    ...
    TodoListComponent.prototype.showAddUserForm = function () {
    ...
    TodoListComponent.prototype.saveUser = function (user) {
        if (this.isNewUser) {
            //add a new user
    ...
    TodoListComponent.prototype.updateUser = function () {
        this.userService.updateUser(this.editedUser);
        this.editUserForm = false;
        this.editedUser = {};
    };
    TodoListComponent.prototype.removeUser = function (user) {
        this.userService.deleteUser(user);
    };
    TodoListComponent.prototype.cancelEdits = function () {
        this.editedUser = {};
        this.editUserForm = false;
    };
    TodoListComponent.prototype.cancelNewUser = function () {
        this.newUser = {};
        this.userForm = false;
    };
    TodoListComponent.prototype.checkbox = function (v) {
...
var TodoserviceService = /** @class */ (function () {
    ...
    TodoserviceService.prototype.getUsersFromData = function () {
        return this.upersons;
    };
    TodoserviceService.prototype.addUser = function (user) {
        user.id = this.upersons.length + 1;
        this.upersons.push(user);
    };
    TodoserviceService.prototype.updateUser = function (user) {
        var index = this.upersons.findIndex(function (u) { return user.id === u.id; });
        this.upersons[index] = user;
    };
    TodoserviceService.prototype.deleteUser = function (user) {
